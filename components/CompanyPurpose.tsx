...
const CompanyPurpose = () => {
    return (
        <div className="px-16 lg:px-32 lg:h-screen justify-center mb-16 lg:mb-32 flex flex-col gap-4">
            ...
            <ul
                role="list"
                className="mx-auto mt-10 lg:mt-20 grid max-w-2xl grid-cols-1 gap-14 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-8"
            >
